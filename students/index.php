...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if (!empty($username && $password)){
        try{
            $stm= $conn->prepare("SELECT * FROM students WHERE RegNo=:u");
            ...
            if ($stm->rowCount() > 0){
                ...
                $emailErr='Student does not exist';
                $Err=array($emailErr);
            }
        ...
        <div id="login_group" class="container mt-3 mb-3">
            ...
            <form id="loginForm" method="post" action="" autocomplete="off">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Enter your Student Registration Number</small>
