<?php
    ...
    $datatables_js = 'vendor/datatables/datatables/media/js/dataTables.bootstrap4.min.js';
    $jqueryDatatables_js = 'vendor/datatables/datatables/media/js/jquery.dataTables.min.js';
    ...
    $popper_js = 'assets/js/popper.v-1.16.0.min.js';
?>